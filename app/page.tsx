...
const Home = () => {
  ...
  return (
    <div className="flex flex-col gap-16">
      ...
      {/* membership */}
      <div style={{ marginLeft: 'calc(50% - 50vw)', marginRight: 'calc(50% - 49vw  - 0.2rem)', background: `url(${imgMembershipBg})`, backgroundPosition: 'center', backgroundRepeat: 'no-repeat', backgroundSize: 'cover' }} className="  aspect-[10/4] flex relative ">
